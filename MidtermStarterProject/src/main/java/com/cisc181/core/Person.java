...
public abstract class Person {
	...
	public Person(String FirstName, String MiddleName, String LastName,
		...
		if (new Date().getYear() - DOB.getYear() >= 100) 
		{ throw new PersonException("DOB more than 100 years older than current date"); }
		else { this.DOB = DOB; }
		...
		else { throw new PersonException("Number not formatted correctly"); }
